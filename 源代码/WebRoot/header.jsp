...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">电子商城网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>ProductClass/frontlist">商品分类</a></li> --> 
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=1">手机相关</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=2">电脑相关</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=3">数码产品</a></li>
                <li><a href="<%=basePath %>ShopCart/userFrontlist">我的购物车</a></li>
                <!-- 
                <li><a href="<%=basePath %>OrderInfo/frontlist">订单</a></li>
                <li><a href="<%=basePath %>OrderItem/frontlist">订单条目</a></li> 
                <li><a href="<%=basePath %>Comment/frontlist">商品评论</a></li>
                -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Product/product_frontUserAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;发布商品</a></li>
                        <li><a href="<%=basePath %>Product/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我发布的商品</a></li>
                        <li><a href="<%=basePath %>ShopCart/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的购物车</a></li>
                        <li><a href="<%=basePath %>OrderInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;已购买的商品订单</a></li>
                        <li><a href="<%=basePath %>OrderInfo/sellerFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我出售的订单</a></li>
                        <li><a href="<%=basePath %>UserInfo/userInfo_frontModify.jsp?user_name=<%=session.getAttribute("user_name") %>"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;修改个人信息</a></li>
                    </ul>
                </li>
