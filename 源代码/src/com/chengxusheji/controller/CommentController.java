...
public class CommentController extends BaseController {
	...
	/*前台用户客户端ajax方式提交添加商品评论信息*/
	@RequestMapping(value = "/userAdd", method = RequestMethod.POST)
	public void userAdd(Comment comment,
		...
		int productId = comment.getProductObj().getProductId();
		String product_userName = productService.getProduct(productId).getUserObj().getUser_name();
		if(product_userName.equals(userName)) {
			message = "你不能评论自己的宝贝！";
			writeJsonResponse(response, success, message);
			return ;
		}
